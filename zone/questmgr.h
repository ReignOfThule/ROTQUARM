...
public:
	...
	Mob* spawn2(int npc_type, int grid, int guild, const glm::vec4& position, const char* name = nullptr);
	Mob* unique_spawn(int npc_type, int grid, int guild, const glm::vec4& position);
